...
const Finish = () => {
  ...
  return (
    <div className={styles.finishContainer}>
      ...
      {typeBuy === "delivery" ? (
        <p className={styles.orderStore}>Pesanan Anda akan diantar dalam waktu 60 menit.</p>
      ) : (
        <p className={styles.orderStore}>Dalam 25 menit pesanan Anda akan siap untuk diambil di toko kami.</p>
      )}
    </div>
  )
}
